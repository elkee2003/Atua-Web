...
import { createCourierCompany } from "../graphql/mutations";
const client = generateClient();
export default function CourierCompanyCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setAdminFirstName(initialValues.adminFirstName);
    setAdminLastName(initialValues.adminLastName);
    setAdminPhoneNumber(initialValues.adminPhoneNumber);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createCourierCompany.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "CourierCompanyCreateForm")}
      {...rest}
    >
      <TextField
        label="Sub"
